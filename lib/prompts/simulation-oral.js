...
RÈGLE IMPORTANTE :
- Les 3-4 PREMIÈRES questions sont PERSONNALISÉES en fonction du CV (parcours, motivation, compétences transférables). Ces questions ne peuvent PAS venir de la banque car elles sont uniques à chaque candidat.
- Les 6-7 questions SUIVANTES sont des questions de connaissance et de mise en situation. Utilise les exemples de la banque de questions fournie dans le system prompt pour les formuler. Tu peux les reprendre TELLES QUELLES ou les reformuler légèrement.

Distribution OBLIGATOIRE :
- Q1 : OUVERTURE — "Présentez-vous" (TOUJOURS en premier, personnalisé)
- Q2 : MOTIVATION — "Pourquoi voulez-vous devenir ATSEM ?" (personnalisé selon le profil)
- Q3 : PARCOURS — Question personnalisée sur le changement de direction / l'expérience
- Q4 : COMPÉTENCES — Question personnalisée sur les compétences transférables de l'ancien métier
- Q5 : MISSIONS — Question sur les missions concrètes de l'ATSEM (de la banque)
- Q6 : SANTÉ/SÉCURITÉ — Question sur un protocole, un PAI, un geste de premier secours (de la banque)
- Q7 : MISE EN SITUATION 1 — Scénario en classe, cantine ou récréation (de la banque)
- Q8 : MISE EN SITUATION 2 — Scénario relationnel : parent, enseignant ou collègue (de la banque)
- Q9 : COLLECTIVITÉS/INSTITUTIONS — Question sur le statut, la hiérarchie ou le droit public (de la banque)
- Q10 : PIÈGE — Question déstabilisante adaptée au CV (personnalisé)
