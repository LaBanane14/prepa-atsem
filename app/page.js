        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
          <a href="/" className="flex items-center gap-3">
            <div className="bg-purple-800 text-white p-2 rounded-xl shadow-sm">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="w-7 h-7">{/* Grande main adulte */}<path d="M4 21V11a1 1 0 0 1 1-1h0a1 1 0 0 1 1 1v5"/><path d="M6 12V8.5a1 1 0 0 1 1-1h0a1 1 0 0 1 1 1V12"/><path d="M8 11V7.5a1 1 0 0 1 1-1h0a1 1 0 0 1 1 1V12"/><path d="M10 11.5V9a1 1 0 0 1 1-1h0a1 1 0 0 1 1 1v3"/><path d="M6 16c0 0-1.5-1-1.5-3"/>{/* Petite main enfant */}<path d="M15 17v-3a0.7 0.7 0 0 1 1.4 0v2" stroke="currentColor" strokeWidth="1.3"/><path d="M16.4 14.5v-1.5a0.7 0.7 0 0 1 1.4 0v2" stroke="currentColor" strokeWidth="1.3"/><path d="M17.8 15v-1a0.7 0.7 0 0 1 1.4 0v1.5" stroke="currentColor" strokeWidth="1.3"/><path d="M19.2 15.5v-0.5a0.7 0.7 0 0 1 1.4 0v1.5" stroke="currentColor" strokeWidth="1.3"/><path d="M15 17c0 1.5 1.2 3 3.5 3s3.1-1.5 3.1-3" stroke="currentColor" strokeWidth="1.3"/></svg>
            </div>
            <div>
        ...
        <div className="max-w-6xl mx-auto px-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="lg:col-span-2">
            <div className="flex items-center gap-2 mb-4">
              <svg className="w-5 h-5 text-purple-500" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M4 21V11a1 1 0 0 1 1-1h0a1 1 0 0 1 1 1v5"/><path d="M6 12V8.5a1 1 0 0 1 1-1h0a1 1 0 0 1 1 1V12"/><path d="M8 11V7.5a1 1 0 0 1 1-1h0a1 1 0 0 1 1 1V12"/><path d="M10 11.5V9a1 1 0 0 1 1-1h0a1 1 0 0 1 1 1v3"/><path d="M6 16c0 0-1.5-1-1.5-3"/><path d="M15 17v-3a0.7 0.7 0 0 1 1.4 0v2" strokeWidth="1.3"/><path d="M16.4 14.5v-1.5a0.7 0.7 0 0 1 1.4 0v2" strokeWidth="1.3"/><path d="M17.8 15v-1a0.7 0.7 0 0 1 1.4 0v1.5" strokeWidth="1.3"/><path d="M19.2 15.5v-0.5a0.7 0.7 0 0 1 1.4 0v1.5" strokeWidth="1.3"/><path d="M15 17c0 1.5 1.2 3 3.5 3s3.1-1.5 3.1-3" strokeWidth="1.3"/></svg>
