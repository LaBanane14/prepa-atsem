        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
          <a href="/" className="flex items-center gap-3">
            <div className="bg-purple-800 text-white p-2 rounded-xl shadow-sm">
              <svg viewBox="0 0 28 28" fill="none" className="w-7 h-7">{/* Face dessus */}<path d="M14 2L26 8L14 14L2 8Z" fill="rgba(255,255,255,0.25)" stroke="currentColor" strokeWidth="1.3" strokeLinejoin="round"/>{/* Face gauche */}<path d="M2 8L14 14L14 26L2 20Z" fill="rgba(255,255,255,0.1)" stroke="currentColor" strokeWidth="1.3" strokeLinejoin="round"/>{/* Face droite */}<path d="M26 8L14 14L14 26L26 20Z" fill="rgba(255,255,255,0.05)" stroke="currentColor" strokeWidth="1.3" strokeLinejoin="round"/>{/* Points face dessus (3) */}<circle cx="9" cy="7" r="1.1" fill="currentColor"/><circle cx="14" cy="8" r="1.1" fill="currentColor"/><circle cx="19" cy="7" r="1.1" fill="currentColor"/>{/* Points face gauche (2) */}<circle cx="6" cy="12.5" r="1" fill="currentColor"/><circle cx="10" cy="21" r="1" fill="currentColor"/>{/* Points face droite (1) */}<circle cx="20" cy="17" r="1.1" fill="currentColor"/></svg>
            </div>
            <div>
        ...
        <div className="max-w-6xl mx-auto px-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="lg:col-span-2">
            <div className="flex items-center gap-2 mb-4">
              <svg className="w-5 h-5 text-purple-500" viewBox="0 0 28 28" fill="none"><path d="M14 2L26 8L14 14L2 8Z" fill="rgba(168,85,247,0.25)" stroke="currentColor" strokeWidth="1.3" strokeLinejoin="round"/><path d="M2 8L14 14L14 26L2 20Z" fill="rgba(168,85,247,0.1)" stroke="currentColor" strokeWidth="1.3" strokeLinejoin="round"/><path d="M26 8L14 14L14 26L26 20Z" fill="rgba(168,85,247,0.05)" stroke="currentColor" strokeWidth="1.3" strokeLinejoin="round"/><circle cx="9" cy="7" r="1.1" fill="currentColor"/><circle cx="14" cy="8" r="1.1" fill="currentColor"/><circle cx="19" cy="7" r="1.1" fill="currentColor"/><circle cx="6" cy="12.5" r="1" fill="currentColor"/><circle cx="10" cy="21" r="1" fill="currentColor"/><circle cx="20" cy="17" r="1.1" fill="currentColor"/></svg>
