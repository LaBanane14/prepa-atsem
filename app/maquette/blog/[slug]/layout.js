// Métadonnées dynamiques calquées sur app/blog/[slug]/layout.js.
// Canonical vers l'article public (la maquette duplique son contenu).
...
export default function MaquetteArticleLayout({ children }) {
  return children
}
