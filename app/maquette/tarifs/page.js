      ...
      <section className="relative px-5 pt-10 pb-16 sm:pt-14 sm:pb-24 fade-in-up">
        ...
        <div className="relative max-w-4xl mx-auto grid" style={{gridTemplateColumns: '1.35fr 0.9fr 1fr'}}>
          ...
          <div className="px-2 sm:px-4 pt-6 pb-7 flex items-start justify-center rounded-b-[24px]" style={COL_M}>
            <a href="/maquette/auth?mode=signup" className="w-full max-w-[210px] inline-flex items-center justify-center bg-white hover:bg-white/90 text-[#0d0d0d] font-bold text-[13px] sm:text-[15px] py-3 rounded-full transition">S&apos;abonner</a>
          </div>
          <div className="px-3 sm:px-5 pt-6 pb-7 flex items-start justify-center rounded-b-[24px]" style={{...COL_S, borderBottom: '2px solid #9333ea'}}>
            <a href="/maquette/auth?mode=signup" className="btn-shine w-full max-w-[230px] inline-flex items-center justify-center gap-2 bg-purple-600 hover:bg-purple-500 text-white font-bold text-[13px] sm:text-[15px] py-3 rounded-full transition shadow-lg shadow-purple-600/25 group">
              S&apos;abonner
