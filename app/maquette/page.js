...
// MAQUETTE DE TRAVAIL — refonte de l'accueil reprise du design Prépa FPC,
// contenus adaptés au concours ATSEM. Non reliée à la navigation du site.
// Ne pas indexer / ne pas déployer telle quelle.
...
const FAQ_DATA = [
  ...
  { q: "Quelles sont les dates du concours ATSEM ?", a: "Pour la session 2026, les inscriptions sont ouvertes du 24 mars au 29 avril 2026 sur concours-territorial.fr, l'épreuve écrite se tient à partir du 14 octobre 2026 et les oraux s'étalent de décembre 2026 à janvier 2027. Retrouvez les dates et les CDG organisateurs de votre région dans <a href='/maquette/calendrier'>notre calendrier des concours</a>." },
    ...
    <>
      ...
      <section className="relative grid place-items-center px-5 pb-4 pt-[68px] md:pt-[150px] text-center">
        ...
        <div className="mt-9 flex flex-col sm:flex-row items-center gap-3">
          <a href="/maquette/auth?mode=signup" className="btn-shine inline-flex items-center gap-2 justify-center bg-[#0d0d0d] hover:bg-black/85 text-white font-semibold text-base px-7 py-3.5 rounded-full transition group">
      ...
      <section id="eligibilite" className="relative overflow-hidden pt-8 pb-12 sm:pt-10 sm:pb-16 px-5 fade-in-up" style={{background: 'linear-gradient(to bottom, #ffffff 0%, #f7f6f4 90px, #f7f6f4 calc(100% - 140px), #ffffff 100%)', scrollMarginTop: '115px'}}>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="relative max-w-4xl mx-auto">
            ...
            <p className="text-center mt-8 text-sm text-black/45 font-medium">Répartition applicable jusqu&apos;en avril 2030 (décret n° 2025-360 du 18 avril 2025). Inscriptions auprès du CDG de votre département du 24 mars au 29 avril 2026 : consultez <a href="/maquette/calendrier" className="text-purple-700 font-bold underline hover:text-purple-800 transition">le calendrier des concours</a>.</p>
            <div className="text-center mt-8">
              <a href="/maquette/auth?mode=signup" className="inline-flex items-center gap-2 bg-slate-600 hover:bg-slate-500 text-white font-bold px-7 py-3.5 rounded-full transition shadow-lg shadow-slate-600/25 group/btn">
              ...
              <div key={i} id={c.ancre} style={{scrollMarginTop: '110px'}} className="relative grid md:grid-cols-2 gap-8 md:gap-24 items-center">
                ...
                <div className={`${i % 2 === 1 ? 'md:order-1' : ''}`}>
                  ...
                  <div className="text-center mt-7">
                    <a href="/maquette/auth?mode=signup" className="inline-flex items-center gap-2 text-[15px] font-bold text-white px-6 py-3 rounded-full transition-transform duration-200 hover:scale-[1.04] group" style={{backgroundColor: c.bord, boxShadow: `0 8px 20px ${c.bord}40`}}>
