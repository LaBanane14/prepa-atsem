...
export default function ArticlePage() {
  ...
  return (
    <article className="max-w-3xl mx-auto px-5 sm:px-6 pt-[110px] md:pt-[140px] pb-16 sm:pb-24">
      ...
      <a href="/blog" className="inline-flex items-center gap-2 text-sm font-bold text-black/45 hover:text-purple-700 transition mb-9">
      ...
      {!user && (
        <div className="relative overflow-hidden mt-14 bg-[#0d0d0d] rounded-[28px] p-10 text-center">
          ...
          <div className="relative">
            ...
            <a href="/auth?mode=signup" className="btn-shine inline-flex items-center gap-2 bg-purple-700 hover:bg-purple-600 text-white font-bold px-8 py-4 rounded-full transition shadow-lg shadow-purple-700/25 group">
